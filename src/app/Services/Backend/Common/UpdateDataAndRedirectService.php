...
class UpdateDataAndRedirectService
{
    /**
    ...
    {
        $fieldsToValidate = $this->request->except(['slug', 'table_secret_key', 'method_type', 'route_path', '_token']);
    ...
    private function updateTableData(string $requestModel, string $tableSecretKey): int
    {
        ...
        $fieldsToUpdate = $this->request->except(['slug', 'table_secret_key', 'method_type', 'route_path', '_token']);
