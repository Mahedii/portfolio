                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills nav-success mb-3" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link waves-effect waves-light active" data-bs-toggle="tab" href="#home-1"
                                    role="tab">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link waves-effect waves-light" data-bs-toggle="tab" href="#profile-1"
                                    role="tab">Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link waves-effect waves-light" data-bs-toggle="tab" href="#messages-1"
                                    role="tab">Messages</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link waves-effect waves-light" data-bs-toggle="tab" href="#settings-1"
                                    role="tab">Settings</a>
                            </li>
                        </ul>
                        <!-- Tab panes -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills nav-justified mb-3" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link waves-effect waves-light" data-bs-toggle="tab"
                                    href="#pill-justified-messages-1" role="tab">
                                    Messages
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link waves-effect waves-light" data-bs-toggle="tab"
                                    href="#pill-justified-settings-1" role="tab">
                                    Settings
                                </a>
                            </li>
                        </ul>
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        ...
                                        <div class="mt-2">
                                            <a href="javascript:void(0);"
                                                class="btn btn-sm btn-soft-primary shadow-none">Read More <i
