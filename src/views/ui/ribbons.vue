                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-4">
                                    <div
                                        class="card ribbon-box border ribbon-fill mb-lg-0"
                                    >
                                        <div class="card-body">
                                ...
                                <div class="col-xxl-4">
                                    <!-- Right Ribbon -->
                                    <div
                                        class="card ribbon-box border ribbon-fill right mb-lg-0"
                                    >
                                        <div class="card-body">
                        ...
                        <div class="d-none code-view">
                            <pre class="language-markup" style="height: 275px;"><code>&lt;b-card class=&quot;ribbon-box border ribbon-fill mb-lg-0&quot;&gt;
    &lt;b-card no-body&gt;
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-none code-view">
                            <pre class="language-markup" style="height: 275px;"><code>&lt;b-card class=&quot;ribbon-box border mb-lg-0&quot;&gt;
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-4">
                                    <div
                                        class="card ribbon-box border overflow-hidden mb-lg-0"
                                    >
                                        <div class="card-body text-muted">
                                            <div
                        ...
                        <div class="d-none code-view">
                            <pre class="language-markup" style="height: 275px;"><code>&lt;b-card class=&quot;ribbon-box border overflow-hidden&quot;&gt;
    &lt;b-card no-body class=&quot;text-muted&quot;&gt;
