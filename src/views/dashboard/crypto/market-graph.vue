...
<template>
  <div class="card">
    <div class="card-header border-0 align-items-center d-flex">
      ...
      <div>
        <button type="button" class="btn btn-soft-secondary btn-sm me-1 shadow-none">1H</button>
        <button type="button" class="btn btn-soft-secondary btn-sm me-1 shadow-none">7D</button>
        <button type="button" class="btn btn-soft-secondary btn-sm me-1 shadow-none">1M</button>
        <button type="button" class="btn btn-soft-secondary btn-sm me-1 shadow-none">1Y</button>
        <button type="button" class="btn btn-soft-primary btn-sm shadow-none">ALL</button>
      </div>
    </div>
    <!-- end card header -->
