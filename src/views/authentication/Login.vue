<script>
    ...
    export default {
        ...
        methods: {
                ...
                try {
                    ...
                    .then(response => {
                        ...
                        if (response.data.success) {
                            ...
                            sessionStorage.setItem('jwt-token-expires-in', expirationTime);
            ...
            async getUser() {
                try {
                  const storedToken = sessionStorage.getItem('jwt-token')
          ...
          <div class="col-lg-12">
            <div class="text-center">
              <p class="mb-0 text-muted">
                &copy; {{ new Date().getFullYear() }} Mahadi. Crafted with
                <i class="mdi mdi-heart text-danger"></i> by Mahadi
              </p>
            </div>
          </div>
        </div>
