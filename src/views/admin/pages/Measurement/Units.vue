        ...
        methods: {
            ...
            async addUnits() {
                try {
                    ...
                    this.this.axios.post('/measurement-units/create', payload)
                    .then(response => {
            ...
            async updateMeasurementUnit() {
                try {
                    ...
                    this.this.axios.post('/measurement-units/update', payload)
                    .then(response => {
                        // console.log(response)
                        if (response.data.status == 200) {
                            customToastr.toastrMessage(response.data.message, "success")
            ...
            async changeStatus(id) {
                ...
                const response = await this.this.axios.post('/measurement-units/update', payload)
                if (response.data.status == 200) {
                    this.fetchMeasurementUnits();
                    customToastr.toastrMessage(response.data.message, "success")
                } else {
