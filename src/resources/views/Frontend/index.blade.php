...
<main id="main_root" class="main-root">
    ...
    <header class="p-relative header-personal d-grid grid-md-2 d-grid-no-space">
        <div class="p-relative box-img ">
            <div class="img-box-parallax before-z-index " data-dsn-triggerhook="top" data-dsn-grid="move-up"
                 data-overlay="4">
                <img src='frontend/assets/img/head-personal.jpg' class=" cover-bg-img has-direction" alt=''/>
            </div>
    ...
    <div id="page_wrapper" class="wrapper">
        ...
        <div class="about-personal container section-margin">
            <div class="box-content pt-section">
                <div class="box-content-inner background-section">
                    ...
                    <p class="max-w750 mt-30 zoomable-text">
            ...
            <div class="box-img p-relative">
                <div class="img-box-parallax before-z-index" data-dsn="parallax" data-overlay="0">
                    <img src='frontend/assets/img/p-1.jpg' class="cover-bg-img" alt=''/>
                </div>
            </div>
        ...
        <section class="our-services section-margin ">
            <div class="container">
                <div class="section-title mb-70">
                    ...
                    <h2 class="title">
                        <span class="top-s">New </span><br>
                        <span class="sub">Branding Agency</span>
                    </h2>
                </div>

                <ul>
                    <li class="d-grid align-items-center ">
                        <h3 class="heading">Digital <br> Experiences</h3>
                    ...
                    <li class="d-grid align-items-center ">
                        <h3 class="heading">SEO <br> copywriting</h3>
                ...
                <div class="dsn-service d-grid grid-lg-3 grid-sm-2 dsn-masonry-grid dsn-masonry-grid-2 dsn-isotope "
                    ...
                    <div class="dsn-up service-item p-relative grid-item ">
                        <div class="service-item-inner background-section number-item h-100">
                            ...
                            <div class="service-content p-relative">
                                <h4 class="service_title  title-block border-top pt-20 border-bottom pb-20 mb-20">WEB DEVELOPMENT</h4>
                                <div class="service_description mt-20 max-w570 dsn-auto">
                                </div>
                    ...
                    <div class="dsn-up service-item p-relative grid-item ">
                        <div class="service-item-inner background-section number-item h-100">
                            ...
                            <div class="service-content p-relative">
                                <h4 class="service_title  title-block border-top pt-20 border-bottom pb-20 mb-20">UI-UX DESIGN</h4>
                                <div class="service_description mt-20 max-w570 dsn-auto">
                                </div>
        ...
        <div class="container section-margin pt-section border-top d-grid grid-md-2" data-dsn-gap="30px 120px">
            <div class="box-left p-relative  pinned-scroll" data-dsn-option='{"end":"250"}'>
                <div class="section-title  pinned-element">
                    <h2 class="title-h2 text-upper">MY SKILLS</h2>
            ...
            <div class="box-right">
                <div class="dsn-skills d-grid">
                    <div class="dsn-skills-item grid-item">
                        <div class="skills-inner">
                            <h6 class="dsn-title-award sm-title-block mb-15">UI Design</h6>
                            <div class="bar-progress">
                                <span class="fill dsn-animate-skill box-shadow background-section" data-dsn-width="98%">
                                    <span class="dsn-number-award number sm-title-block">0%</span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dsn-skills-item grid-item">
                        <div class="skills-inner">
                            ...
                            <h6 class="dsn-title-award sm-title-block mb-15">UX Design</h6>
                            <div class="bar-progress">
                                <span class="fill dsn-animate-skill box-shadow background-section "
                                        data-dsn-width="95%">
                                    <span class="dsn-number-award number sm-title-block">0%</span>
                                </span>
                            </div>
                    ...
                    <div class="dsn-skills-item grid-item">
                        <div class="skills-inner">
                            <h6 class="dsn-title-award sm-title-block mb-15">Product Design</h6>
                            <div class="bar-progress">
                                <span class="fill dsn-animate-skill box-shadow background-section" data-dsn-width="85%">
                                    <span class="dsn-number-award number sm-title-block">0%</span>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="dsn-skills-item grid-item">
                        <div class="skills-inner">
                            <h6 class="dsn-title-award sm-title-block mb-15">Design Thinking</h6>
                            <div class="bar-progress">
                                <span class="fill dsn-animate-skill box-shadow background-section" data-dsn-width="80%">
                                    <span class="dsn-number-award number sm-title-block">0%</span>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="dsn-skills-item grid-item">
                        <div class="skills-inner">
                            <h6 class="dsn-title-award sm-title-block mb-15">User Research</h6>
                            <div class="bar-progress">
                                <span class="fill dsn-animate-skill box-shadow background-section" data-dsn-width="60%">
                                    <span class="dsn-number-award number sm-title-block">0%</span>
                                </span>
                            </div>
                        </div>
        ...
        <div class="container section-margin pt-section border-top d-grid grid-md-2" data-dsn-gap="30px 120px">
            <div class="box-left p-relative  pinned-scroll" data-dsn-option='{"end":"250"}'>
                <div class="section-title  pinned-element">
                    <h2 class="title-h2 text-upper">My past experience</h2>
                    <p class="max-w350 mt-20">
                        Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nullat.
                    </p>
                </div>
        ...
        <div class="section-animation">
            <div class="marquee">
                <div class="marquee__inner-wrap">
                    <a href="contact.html"
                        class="marquee__inner v-dark background-section title-slider effect-ajax">
                    ...
                    <a href="contact.html"
                        class="marquee__inner v-light border-top background-section title-slider two effect-ajax">
                        <span>Contact Us</span>
                        <span>Contact Us</span>
                        <span>Contact Us</span>
                        <span>Contact Us</span>
            ...
            <a href="contact.html" class="effect-ajax p-absolute w-100 h-100 top-0 left-0"  data-dsn-text="Contact Us"></a>
        ...
        <div class="container section-margin pt-section border-top d-grid grid-md-2" data-dsn-gap="30px 120px">
            <div class="box-left p-relative  pinned-scroll" data-dsn-option='{"end":"250"}'>
                <div class="section-title  pinned-element">
                    <h2 class="title-h2 text-upper">Contact me</h2>
                    <p class="max-w350 mt-20">
                        Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nullat.
                    </p>
                </div>
            ...
            <div class="box-right">
                ...
                <div class="dsn-form mt-20 form-box d-flex flex-column">
                    <form id="contact-form" class="form w-100" method="post" action="https://theme.dsngrid.com/blackdsn/dark/contact.php"
                        ...
                        <div class="input__wrap controls">
                            ...
                            <div class="d-flex justify-content-end dsn-up" >
                        ...
                        <div class="grid-col-2">
                            ...
                            <div class="menu-footer-menu-container">
                                <ul id="menu-footer-menu" class="menu">
                                    <li class="menu-item">
                                        <a href="home.html" data-dsn-split="chars" class="effect-ajax" data-dsn-ajax="slider">HOME</a>
                                    </li>
                                    <li class="menu-item">
...
<script>
    /* */
    document.getElementById("dsn_scroll_to_top").onclick = function() {
