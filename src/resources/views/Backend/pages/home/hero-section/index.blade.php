...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function handleFileSelect(event) {
            ...
            for (let i = 0; i < files.length; i++) {
                ...
                reader.onload = (e) => {
                    ...
                    document.querySelector(".file-previews").appendChild(preview);
                    updateArrowButtonVisibility();
                };
        ...
        function handleDragEnd() {
            ...
            // Restore scroll behavior after dragging ends
            document.querySelector(".file-previews").style.scrollBehavior = "smooth";
        }
