<script type="text/javascript">
    ...
    $(document).ready(function () {
         ...
         */
        $(document).on("submit", "#aboutMeUpdateForm", function(e){

            e.preventDefault();

            $('#aboutMeUpdateForm .ajax-submit .submit-btn-text').toggleClass('hide');
            $('#aboutMeUpdateForm .ajax-submit .ajax-spinner').toggleClass('hide');
            var classNameOrId = "#aboutMeUpdateForm";

            var form = $('#aboutMeUpdateForm')[0];
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status == 200) {
                        ...
                        $(".about_myselves_title").val(data.updatedRowData[0].title);
                        $(".about_myselves_subtitle").val(data.updatedRowData[0].subtitle);
                        $(".about_myselves_description").val(data.updatedRowData[0].description);
