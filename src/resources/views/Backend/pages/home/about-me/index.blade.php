    ...
    <div class="col-xxl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">About Me</h4>
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form action="javascript:void(0);" enctype="multipart/form-data" class="row g-3" id="aboutMeUpdateForm">
                        @csrf
                        @foreach ($aboutMeData as $data)
                            <div class="row mt-2 py-2">
                                <div class="col-md-6">
                                    <label for="title" class="form-label">Title<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control ajax-validation-input about_myselves_title @error('title') is-invalid @enderror" value="{{ $data->title }}" name="title">
                            ...
                            <div class="row mt-2 py-2">
                                <div class="col-md-12">
                                    ...
                                    <p class="text-muted">Max 150 characters allowed</p>
                                    <textarea class="form-control ajax-validation-input about_myselves_subtitle" name="subtitle" rows="3">{{ Str::limit($data->subtitle, 150) }}</textarea>
                            ...
                            <div class="row mt-2 py-2">
                                <div class="col-md-12">
                                    ...
                                    <p class="text-muted">Max 450 characters allowed</p>
                                    <textarea class="form-control ajax-validation-input about_myselves_description" name="description" id="ckeditor-classic" rows="3">{{ Str::limit($data->description, 450) }}</textarea>
                            ...
                            <div class="row mt-2 py-2">
                                <div class="col-md-12">
                                    <label for="quote" class="form-label">Image (1000*1500)<span class="text-danger">*</span></label>
...
@include('Backend.pages.home.about-me.ajax.index')
