<script type="text/javascript">
    ...
    $(document).ready(function () {
         ...
         */
        $(document).on("submit", "#contactSectionUpdateForm", function(e){

            e.preventDefault();

            $('#contactSectionUpdateForm .ajax-submit .submit-btn-text').toggleClass('hide');
            $('#contactSectionUpdateForm .ajax-submit .ajax-spinner').toggleClass('hide');
            var classNameOrId = "#contactSectionUpdateForm";

            var form = $('#contactSectionUpdateForm')[0];
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status == 200) {
                        ...
                        $(".contact_sections_title").val(data.updatedRowData[0].title);
                        $(".contact_sections_subtitle").val(data.updatedRowData[0].subtitle);
