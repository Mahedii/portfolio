...
@slot('title')Contact Section @endslot
@endcomponent
    ...
    <div class="col-xxl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Contact Section</h4>
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form action="javascript:void(0);" enctype="multipart/form-data" class="row g-3" id="contactSectionUpdateForm">
                        @csrf
                        @foreach ($contactSectionData as $data)
                            <div class="row mt-2 py-2">
                                <div class="col-md-6">
                                    <label for="title" class="form-label">Title<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control ajax-validation-input contact_sections_title @error('title') is-invalid @enderror" value="{{ $data->title }}" name="title">
                            ...
                            <div class="row mt-2 py-2">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control ajax-validation-input contact_sections_subtitle" name="subtitle" rows="3">{{ Str::limit($data->subtitle, 150) }}</textarea>
...
@include('Backend.pages.contact.contact-section.ajax.index')
