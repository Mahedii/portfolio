                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('user.signin') }}" method="POST">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <div>
                                            <a href="{{ route('social.auth.redirectTo','facebook') }}" class="btn btn-primary btn-icon waves-effect waves-light"><i class="ri-facebook-fill fs-16"></i></a>
                                            <a href="{{ route('social.auth.redirectTo','google') }}" class="btn btn-danger btn-icon waves-effect waves-light"><i class="ri-google-fill fs-16"></i></a>
