...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <div>
                                            <a href="<?php echo e(route('social.auth.redirectTo','facebook')); ?>" class="btn btn-primary btn-icon waves-effect waves-light"><i class="ri-facebook-fill fs-16"></i></a>
                                            <a href="<?php echo e(route('social.auth.redirectTo','google')); ?>" class="btn btn-danger btn-icon waves-effect waves-light"><i class="ri-google-fill fs-16"></i></a>
...
<?php echo $__env->make('Backend.layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\portfolio\src\resources\views/auth/login.blade.php ENDPATH**/ ?>