...
<template>
    <div class="app-menu navbar-menu border-end" style="left: 0; padding: 20px; overflow-y: auto;">
        <!-- LOGO -->
        ...
        <div id="scrollbar" style="padding:30px 0">
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse"
                            ...
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Pages</span>
                        </a>
                        <div class="collapses menu-dropdown" id="sidebarDashboards">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <router-link to="/about" class="nav-link" data-key="t-analytics">
                                        About </router-link>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarApps">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarEmail">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <div class="collapses menu-dropdown" id="sidebaremailTemplates">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarEcommerce">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarProjects">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarTasks">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarCRM">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarCrypto">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarInvoices">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarTickets">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarnft">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarLayouts">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarAuth">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <router-link to="/login" class="nav-link" data-bs-toggle="collapse"
                                        role="button" aria-expanded="false" aria-controls="sidebarSignIn"
                                        data-key="t-signin"> Sign In
                                    </router-link>
                                    <div class="collapses menu-dropdown" id="sidebarSignIn">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarSignUp">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarResetPass">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarchangePass">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarLockScreen">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarLogout">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarSuccessMsg">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarTwoStep">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarErrors">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarPages">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarProfile">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarLanding">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown mega-dropdown-menu" id="sidebarUI">
                            <div class="row">
                                <div class="col-lg-4">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarAdvanceUI">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarForms">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarTables">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarCharts">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarApexcharts">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarIcons">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarMaps">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapses menu-dropdown" id="sidebarMultilevel">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapses menu-dropdown" id="sidebarAccount">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
