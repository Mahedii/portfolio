...
(function ($) {
  ...
  function mouseCirMove($off) {
    ...
    dsnGrid.mouseHover("a:not(> img):not(.vid) , .dsn-button-sidebar,  button , .button-load-more , [data-cursor=\"open\"]", {
      enter: function() {
        ...
        gsap.to($element, 0.5, {
          ...
          fontSize: "+=2px", // Increase font size
    ...
    // dsnGrid.mouseHover("span, p", {
      // enter: function() {
      //   // $(this).find('.typing-word').addClass('hovered-element-text');
      //   $(this).addClass('hovered-element-text');
      // },
      // leave: function() {
      //   $(this).removeClass('hovered-element-text');
      // }
    // });
