                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarWorkExp">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('workHistoryPage')); ?>" class="nav-link"> <?php echo app('translator')->get('translation.work-history'); ?> </a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<?php /**PATH D:\xampp\htdocs\portfolio\backend\resources\views/Backend/layouts/sidebar.blade.php ENDPATH**/ ?>